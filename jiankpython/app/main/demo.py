...
ACCESS_KEY_ID = "LTAIuxqrc7pgjeTl"
ACCESS_KEY_SECRET = "ybZJEPO69YWjTyZtpd74QMxTrwCjHX"
...
if __name__ == 'send':
    ...
    print send_sms(__business_id, "15082462046", "康动我心", "SMS_105175028", params)

if __name__ == 'query':
    print query_send_detail("1234567^8901234", "15082462046", 10, 1, "20171018")
